  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-purple-600">
      ...
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
        <h2 className="text-3xl text-center font-bold text-gray-800">Login</h2>
        <form onSubmit={handleLogin} className="mt-8 space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2 border border-purple-600 text-purple-60 rounded-md hover:text-white hover:bg-purple-600"
          >
            Log In
          </button>
        </form>
